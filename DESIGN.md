...
- **Project type:** 데스크톱 웹앱 (localhost, 1440px, 순수 APP UI — 마케팅 페이지 없음)
...
## Layout
- **Approach:** grid-disciplined 작업대. 1440px 데스크톱 전용.
- **구조:** 좌측 사이드바(168px, 하단 장부 상태 스트립) + 메인 캔버스. (승인 와이어프레임 v3 기준)
